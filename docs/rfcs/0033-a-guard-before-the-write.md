...
> **Withdrawn** on the acceptance of RFC 0035 (#536), which closes the hole this RFC describes without taking any
> of the three options below: the guard stays where it is, and a write of a guarded shape takes the whole record,
> made upstream of the effect. This file stays as the record of what was considered and why each option was not
> taken; RFC 0035's "Drawbacks and alternatives" carries the reasons.
