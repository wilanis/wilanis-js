...
| RFC | Title | Status |
|---|---|---|
| [0001](0001-the-rfc-process.md) | The RFC process | implemented |
...
| [0005](0005-externalized-state.md) | Externalized state: every store behind a port the project binds | implemented |
...
| [0009](0009-queue-triggers-and-workers.md) | Queue messages as triggers, and workers | implemented |
| [0010](0010-scheduled-triggers.md) | Scheduled triggers | implemented |
...
| [0013](0013-deployment-and-profiles.md) | A deployment model: profiles, environments and what a tree needs to run | implemented |
