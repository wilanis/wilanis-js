...
describe('beat 1, the hook: the tree as it ships, and what the rule reaches', () => {
  it('checks ok at 200 documents, and describe computes the five routes the rule reaches', () => {
    expect(refusalsAt(dir)).toEqual([]);
    expect(documents()).toBe(200);
...
describe('beat 3, following the hints', () => {
  ...
  it('the finished route yields ok, at 201 documents', () => {
